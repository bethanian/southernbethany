...
export const FacebookIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 2.04c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm2.24 10.38h-1.67v5.58h-2.5v-5.58H8.5V9.07h1.57V8.11c0-1.26.77-2.33 2.33-2.33h1.49v1.67h-1.04c-.22 0-.42.2-.42.42v1.19h1.46l-.23 1.31z" />
    </svg>
);
